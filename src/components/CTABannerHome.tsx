          ...
          <div className="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
            <div className="lg:self-center">
              ...
              <a
                ...
                className="mt-8 inline-flex items-center rounded-md border border-transparent bg-black px-5 py-3 text-base font-bold text-c-yellow shadow hover:text-c-grey"
              >
                Learn More
              </a>
            </div>
